...
function get_loki() {
    ...
    # loki
    ##################
    local filename="loki-linux-${ARCH:-amd64}"
    ...
    # promtail
    ##################
    local filename="promtail-linux-${ARCH:-amd64}"
    local tarball="${filename}.zip"
    local url="https://github.com/grafana/loki/releases/download/v${version}/${tarball}"
    if [[ ! -f ${tmpdir}/${tarball} || ${remove} == "yes" ]] ; then
    ...
    # logcli
    ##################
    local filename="logcli-linux-${ARCH:-amd64}"
    local tarball="${filename}.zip"
    local url="https://github.com/grafana/loki/releases/download/v${version}/${tarball}"
    ...
    # loki-canary
    ##################
    local filename="loki-canary-linux-${ARCH:-amd64}"
    local tarball="${filename}.zip"
    local url="https://github.com/grafana/loki/releases/download/v${version}/${tarball}"
